...
def collate_MIL(batch):
	...
	if not torch.is_tensor(batch[0][0]):
		raise TypeError(
			f"collate_MIL expected Tensor features but got {type(batch[0][0]).__name__}. "
			"This usually means the feature directory was not configured correctly."
		)
